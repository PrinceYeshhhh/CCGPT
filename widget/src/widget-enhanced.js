/**
 * CustomerCareGPT Enhanced Embeddable Chat Widget
 * Version: 2.0.0
 * Features: WebSocket support, enhanced theming, security, rate limiting
 */
...
(function() {
  ...
  function init(config) {
    // Load configuration from script attributes or config object
    loadConfig(config);
  ...
  function loadConfig(config) {
    ...
    if (script) {
      CONFIG.embedCodeId = script.getAttribute('data-embed-id');
      CONFIG.clientApiKey = script.getAttribute('data-api-key');
