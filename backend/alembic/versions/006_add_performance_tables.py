...
def upgrade():
    ...
    op.create_index('idx_workspace_id', 'performance_metrics', ['workspace_id'])
    op.create_index('idx_user_id', 'performance_metrics', ['user_id'])
    op.create_index('idx_metric_type', 'performance_metrics', ['metric_type'])
    op.create_index('idx_session_id', 'performance_metrics', ['session_id'])
    op.create_index('idx_timestamp', 'performance_metrics', ['timestamp'])
    op.create_index('idx_workspace_timestamp', 'performance_metrics', ['workspace_id', 'timestamp'])
    op.create_index('idx_workspace_metric_type', 'performance_metrics', ['workspace_id', 'metric_type'])
    op.create_index('idx_user_timestamp', 'performance_metrics', ['user_id', 'timestamp'])
    op.create_index('idx_metric_type_timestamp', 'performance_metrics', ['metric_type', 'timestamp'])
    ...
    op.create_index('idx_workspace_id', 'performance_alerts', ['workspace_id'])
    op.create_index('idx_severity', 'performance_alerts', ['severity'])
    op.create_index('idx_created_at', 'performance_alerts', ['created_at'])
    op.create_index('idx_workspace_created', 'performance_alerts', ['workspace_id', 'created_at'])
    op.create_index('idx_severity_resolved', 'performance_alerts', ['severity', 'is_resolved'])
    ...
    op.create_index('idx_workspace_id', 'performance_configs', ['workspace_id'])
    ...
    op.create_index('idx_workspace_id', 'performance_reports', ['workspace_id'])
    op.create_index('idx_generated_at', 'performance_reports', ['generated_at'])
    op.create_index('idx_workspace_generated', 'performance_reports', ['workspace_id', 'generated_at'])
    op.create_index('idx_report_period', 'performance_reports', ['report_period'])
    ...
    op.create_index('idx_workspace_id', 'performance_benchmarks', ['workspace_id'])
    op.create_index('idx_benchmark_type', 'performance_benchmarks', ['benchmark_type'])
    op.create_index('idx_started_at', 'performance_benchmarks', ['started_at'])
    op.create_index('idx_workspace_benchmark', 'performance_benchmarks', ['workspace_id', 'benchmark_type'])
